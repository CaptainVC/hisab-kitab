#!/usr/bin/env node
/*
Replace subcategory code occurrences in HK_*.xlsx.

Usage:
  node replace_subcategory_code.js --base-dir /home/molt/HisabKitab --from TRANSPORT_PETROL --to TRANSPORT_FUEL [--dry-run]

Backups created in baseDir/backups/replace_subcat_<ts>/
*/
...
function main(){
  ...
  const backupDir=path.join(baseDir,'backups',`replace_subcat_${ts()}`);
