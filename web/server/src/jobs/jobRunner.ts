...
export type JobType = 'ingest' | 'rebuild' | 'stageCommit' | 'stageCommitRows' | 'reviewReimburse' | 'mailIngestOrders' | 'mailMatchReport' | 'mailCrossref' | 'mailReconcile' | 'editTxn' | 'refsGitSync' | 'splitTxn';
