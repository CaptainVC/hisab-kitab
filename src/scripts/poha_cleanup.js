#!/usr/bin/env node
/*
Cleanup POHA merchant usage.
- For any row with merchant_code === 'POHA', set merchant_code to ''
- Set category=FOOD_DINING, subcategory=FOOD_TAKEAWAY

Edits HK_*.xlsx in-place under baseDir. Makes backups.

Usage:
  node poha_cleanup.js --base-dir /home/molt/HisabKitab [--dry-run]
*/
...
function main(){
  ...
  const stamp=ts();
  const backupDir=path.join(baseDir,'backups',`poha_cleanup_${stamp}`);
